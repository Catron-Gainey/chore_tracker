...
from flask_app.models.chore import Chore # import entire file, rather than class, to avoid circular imports
...
def show_dashboard():
    ...
    return render_template("dashboard.html", chores = Chore.get_all_chores_with_user(), session_user_id=session_user_id)
